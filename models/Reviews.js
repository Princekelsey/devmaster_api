...
REVIEW_SCHEMA.index({ bootcamp: 1, user: 1 }, { unique: true });

REVIEW_SCHEMA.statics.getAverageRating = async function (bootcampId) {
...
REVIEW_SCHEMA.pre("save", function () {
  this.constructor.getAverageRating(this.bootcamp);
});

// call getAverageCost before remove
REVIEW_SCHEMA.post("remove", function () {
  this.constructor.getAverageRating(this.bootcamp);
});
